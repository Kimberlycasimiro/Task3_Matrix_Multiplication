...
public class SpeedupChart {

    public static void main(String[] args) {
        String csvFilePath = "results/benchmark_results.csv";
        String outputChartPath = "output_charts/speedup_chart.png";

        generateSpeedupChart(csvFilePath, outputChartPath);
    }

    public static void generateSpeedupChart(String csvFilePath, String outputChartPath) {
        ...
        try (CSVReader csvReader = new CSVReaderBuilder(
            ...
            while ((line = csvReader.readNext()) != null) {
                try {
                    ...
                    double speedup = Double.parseDouble(line[4].replace(",", "."));
                    ...
                    dataset.addValue(speedup, seriesKey, Integer.toString(matrixSize));
            ...
            System.out.println("Speedup chart generated at: " + outputChartPath);
