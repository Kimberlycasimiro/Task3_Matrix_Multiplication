...
public class CPUUsageChart {
    ...
    public static void main(String[] args) {
        ...
        String outputChartPath = "output_charts/cpu_usage_chart.png";

        generateCPUUsageChart(csvFilePath, outputChartPath);
    }

    public static void generateCPUUsageChart(String csvFilePath, String outputChartPath) {
        ...
        try (CSVReader csvReader = new CSVReaderBuilder(
            ...
            while ((line = csvReader.readNext()) != null) {
                try {
                    ...
                    double cpuUsage = Double.parseDouble(line[7].replace(",", "."));
                    ...
                    dataset.addValue(cpuUsage, seriesKey, Integer.toString(matrixSize));
