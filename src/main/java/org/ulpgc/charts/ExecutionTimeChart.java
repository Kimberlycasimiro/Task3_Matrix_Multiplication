...
public class ExecutionTimeChart {

    public static void main(String[] args) {
        String csvFilePath = "results/benchmark_results.csv";
        String outputChartPath = "output_charts/execution_time_chart.png";

        generateExecutionTimeChart(csvFilePath, outputChartPath);
    }

    public static void generateExecutionTimeChart(String csvFilePath, String outputChartPath) {
        ...
        try (CSVReader csvReader = new CSVReaderBuilder(
            ...
            while ((line = csvReader.readNext()) != null) {
                try {
                    ...
                    double executionTime = Double.parseDouble(line[3].replace(",", "."));
                    ...
                    dataset.addValue(executionTime, seriesKey, Integer.toString(matrixSize));
